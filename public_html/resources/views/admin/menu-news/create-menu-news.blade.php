        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="dashboard_graph">
                ...
                <div class="col-md-12">
                    ...
                    <form id="demo-form2" data-parsley-validate action="{{URL::asset('')}}admin/menu-news/create-menu-news"
                                ...
                                <div id="home{{$lang->id}}" class="tab-pane fade">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <input type="text" id="" name="menu_news_name{{$lang->id}}" required="required"
