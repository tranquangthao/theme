...
@section('content')
    <div class="row">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <a href="{{URL::asset('')}}admin/product/create-product" class="btn btn-sm btn-success addlink"><span
                        class="glyphicon glyphicon-plus"></span> Create product</a>
                ...
                <div class="row x_title">
                    ...
                    <div class="col-md-6">
                        ...
                        @foreach($language as $lang)
                            <a href="{{URL::asset('')}}admin/{{$lang->id}}-product"
                    ...
                    <table class="table table-bordered table-responsive projecttable">
                        ...
                        @foreach($products as $product)
                            <tr>
                                ...
                                <td><img src="{{URL::asset('')}}images/products/{{$product->avatar}}"
                                ...
                                <td>
                                    ...
                                    @else
                                    <a class="label label-danger">Unapproved</a>
                                    @endif
                                </td>
                                <td>
                                    <a href="{{URL::asset('')}}admin/product/edit-product-{{$product->id}}"
                                       class="btn btn-xs btn-primary editlink"><span
                                                class="glyphicon glyphicon-pencil"></span>
                                        Edit</a>
                                    @if($loop->count > 2)
                                    <a href="{{URL::asset('')}}admin/product/delete-product-{{$product->id}}"
