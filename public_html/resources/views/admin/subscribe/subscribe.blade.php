                    ...
                    <table class="table table-bordered table-responsive projecttable">
                        ...
                        @foreach($subscribes as $subscribe)
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::asset('')}}admin/subscribe/edit-subscribe-{{$subscribe->id}}"
                                       class="btn btn-xs btn-primary editlink"><span
                                                class="glyphicon glyphicon-pencil"></span>
                                        Edit</a>

                                    <a href="{{URL::asset('')}}admin/subscribe/delete-subscribe-{{$subscribe->id}}"
...
@section('scripts')
    ...
    {{--$("#imgsubscribe").on('change', function () {--}}
