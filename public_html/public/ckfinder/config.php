...
$config['LicenseName'] = 'Nguyễn Thái Châu';
$config['LicenseKey'] = 'A1FHPLGGLDYB6BKGJXHX1UJSK86AHUYY';
...
$baseUrl = 'http://' . $_SERVER['SERVER_NAME'] . '/images';
/*
